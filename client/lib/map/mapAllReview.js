...
// 마커 이미지의 이미지 주소입니다
const imageSrc = "/assets/icons/map-secondary.svg"; 
    
for (let i = 0; i < positions.length; i ++) {
    
    // 마커 이미지의 이미지 크기 입니다
    let imageSize = new kakao.maps.Size(24, 31); 
...
let content = `<div class="font-semibold text-base text-white bg-secondary  rounded-md">&nbsp;마포곱창타운 연남점&nbsp;</div>`;
